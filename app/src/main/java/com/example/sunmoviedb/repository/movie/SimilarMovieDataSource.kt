...
class SimilarMovieDataSource(
    ...
    override fun loadInitialFromSource(
        ...
        loadInitialData(
            params, callback, movieApi.getSimilarMovies(movieId, ApiConstants.STARTED_PAGE)
        )
    }
    ...
    override fun loadAfterFromSource(
        ...
        loadAfterData(params, callback, movieApi.getSimilarMovies(movieId, params.key))
    }
    ...
    class Factory(
        ...
        val sourceLiveData = MutableLiveData<SimilarMovieDataSource>()

        override fun create(): DataSource<Int, CategoryMovie> {
            val source =
                SimilarMovieDataSource(movieApi, movieId, schedulerProvider, compositeDisposable)
