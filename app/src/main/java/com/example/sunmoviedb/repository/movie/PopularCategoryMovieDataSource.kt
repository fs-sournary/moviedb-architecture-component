 ...
 * Description:
 **/
class PopularCategoryMovieDataSource(
    ...
    override fun loadInitialFromSource(
        ...
        loadInitialData(params, callback, movieApi.getPopularMovies(ApiConstants.STARTED_PAGE))
    }
    ...
    override fun loadAfterFromSource(
        ...
        loadAfterData(params, callback, movieApi.getPopularMovies(params.key))
    }
    ...
    class Factory(
        ...
        val sourceLiveData = MutableLiveData<PopularCategoryMovieDataSource>()

        override fun create(): DataSource<Int, CategoryMovie> {
            val source =
                PopularCategoryMovieDataSource(movieApi, schedulerProvider, compositeDisposable)
